...
public class CouponMessageFragment extends BaseListFragment<MessageListInfo.MessageItem> implements MessagesContract.MessageListView, HeaderViewLayout.OnRefreshListener, MessageAdapter.OnItemClick {
    @Inject
