...
public class MyClickRatingBar extends LinearLayout {
    ...
    public MyClickRatingBar(Context context) {
        super(context);
    }

    public MyClickRatingBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        initData(context,attrs);
    }

    public MyClickRatingBar(Context context, AttributeSet attrs, int defStyleAttr) {
