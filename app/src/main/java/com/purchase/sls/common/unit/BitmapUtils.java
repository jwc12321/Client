...
public class BitmapUtils {
     ...
     * @return
     */
    private static Bitmap getImage(String srcPath, Activity activity) {
        ...
        float hh =dm.heightPixels;// 这里设置高度为800f
        float ww = dm.widthPixels;// 这里设置宽度为480f
     ...
     * @return
     */
    public static String compressImageUpload(String path,Activity activity) {
        String filename = path.substring(path.lastIndexOf("/") + 1);
        Bitmap image = getImage(path,activity);
