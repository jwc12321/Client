package com.purchase.sls.common.widget.newbanner;
...
import com.purchase.sls.common.widget.newbanner.listener.OnBannerClickListener;
import com.purchase.sls.common.widget.newbanner.listener.OnBannerListener;
import com.purchase.sls.common.widget.newbanner.loader.ImageLoaderInterface;
import com.purchase.sls.common.widget.newbanner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private int mLayoutResId =R.layout.newbanner;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs,R.styleable.newBanner);
        mIndicatorWidth = typedArray.getDimensionPixelSize(R.styleable.newBanner_new_indicator_width, indicatorSize);
        mIndicatorHeight = typedArray.getDimensionPixelSize(R.styleable.newBanner_new_indicator_height, indicatorSize);
        mIndicatorMargin = typedArray.getDimensionPixelSize(R.styleable.newBanner_new_indicator_margin, BannerConfig.PADDING_SIZE);
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.newBanner_new_indicator_drawable_selected, R.drawable.gray_radius);
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.newBanner_new_indicator_drawable_unselected, R.drawable.white_radius);
        scaleType = typedArray.getInt(R.styleable.newBanner_new_image_scale_type, scaleType);
        delayTime = typedArray.getInt(R.styleable.newBanner_new_delay_time, BannerConfig.TIME);
        scrollTime = typedArray.getInt(R.styleable.newBanner_new_scroll_time, BannerConfig.DURATION);
        isAutoPlay = typedArray.getBoolean(R.styleable.newBanner_new_is_auto_play, BannerConfig.IS_AUTO_PLAY);
        titleBackground = typedArray.getColor(R.styleable.newBanner_new_title_background, BannerConfig.TITLE_BACKGROUND);
        titleHeight = typedArray.getDimensionPixelSize(R.styleable.newBanner_new_title_height, BannerConfig.TITLE_HEIGHT);
        titleTextColor = typedArray.getColor(R.styleable.newBanner_new_title_textcolor, BannerConfig.TITLE_TEXT_COLOR);
        titleTextSize = typedArray.getDimensionPixelSize(R.styleable.newBanner_new_title_textsize, BannerConfig.TITLE_TEXT_SIZE);
        mLayoutResId = typedArray.getResourceId(R.styleable.newBanner_new_banner_layout, mLayoutResId);
        bannerBackgroundImage = typedArray.getResourceId(R.styleable.newBanner_new_banner_default_image, R.mipmap.no_banner);
        typedArray.recycle();
    }
