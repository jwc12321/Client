...
import com.purchase.sls.common.widget.chooseTime.adapter.WheelViewAdapter;
...
//		centerDrawable.draw(canvas);
        ...
        int center = getHeight() / 2;
        int offset = (int) (getItemHeight() / 2 * 1.1);
        ...
        // 线颜色
        paint.setColor(getResources().getColor(R.color.appText9));
        // 设置线宽
