...
public class LotteryOrderFragment extends BaseListFragment<ActivityOrderInfo> implements HeaderViewLayout.OnRefreshListener, OrderManageContract.ActivityOrderListView, ActivityOrderAdatper.HostAction {

    @Inject
    ActivityOrderListPresenter activityOrderListPresenter;
    private ActivityOrderAdatper activityOrderAdatper;

    public static LotteryOrderFragment newInstance() {
        LotteryOrderFragment fragment = new LotteryOrderFragment();
        return fragment;
    }
    ...
    public void onLoadMore() {
        activityOrderListPresenter.getMoreActivityOrderList("3");
    }
